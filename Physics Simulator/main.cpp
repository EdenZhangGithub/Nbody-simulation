...
Game NbodySim(SCREEN_WIDTH, SCREEN_HEIGHT);
...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "NbodySim", nullptr, nullptr);
